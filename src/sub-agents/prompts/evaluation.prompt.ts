...
export function generateDecisionPrompt(intent: Project) {
    return `
        ...
        1. Use the INTENT data (goal, task, problem, constraint) to answer questions below:
        ...
        4. DECISION TREE:
            ...
            Does the INTENT data require multiple steps that depend on each other?
            ...
            Does the INTENT data need adaptation?
            ...
            Does the INTENT data need complex reasoning?
            ...
            Does the INTENT data need external actions?
